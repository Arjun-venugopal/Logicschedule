      ...
      {!showRoster ? (
        <>
          ...
          <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-8 md:p-12 flex flex-col items-center justify-center text-center shrink-0">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Student Roster</h3>
            <p className="text-neutral-400 text-sm mb-6 max-w-md">
              View the complete list of all registered students, manage their profiles, and update batch assignments.
            </p>
            <button
              onClick={() => setShowRoster(true)}
              className="flex items-center gap-2 px-6 py-3 brand-gradient text-black font-bold rounded-xl hover:opacity-90 transition-opacity shadow-lg shadow-amber-500/20"
            >
              <Users className="w-5 h-5" /> View All Students
            </button>
          </div>
        </>
      ) : (
        <div className="flex-1 bg-neutral-900 border border-neutral-800 rounded-2xl flex flex-col min-h-[400px] overflow-hidden">
          <div className="p-5 border-b border-neutral-800 flex items-center justify-between bg-neutral-800/20">
            <h3 className="font-semibold text-white flex items-center gap-2">
